          ...
          <table class="table align-items-center table-flush table-hover text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="p-2">{{ $row->classroom_student_num }}人</td>
                <td class="p-2">{{ $row->classroom_type }}</td>
                <td class="p-2">
                  <form action="classroom/{{$row->classroom_id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href='/classroom/{{$row->classroom_id}}'><button type="button" class="btn btn-primary btn-sm">查看详情</button></a>
