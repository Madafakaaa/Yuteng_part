...
@section('nav')
    ...
    <li class="breadcrumb-item active">添加等级</li>
@endsection
  ...
  <div class="row justify-content-center">
    <div class="col-lg-6 col-md-9 col-sm-12 card-wrapper ct-example">
      <div class="card main_card" style="display:none">
        <form action="/level" method="post" id="form1" name="form1">
          @csrf
          <div class="card-header">
            <h3 class="mb-0">添加等级</h3>
          </div>
          <!-- Card body -->
          <div class="card-body">
            <div class="form-group">
              <label class="form-control-label">等级名称<span style="color:red">*</span></label>
              <input class="form-control" type="text" name="input1" placeholder="请输入等级名称..." autocomplete='off' required maxlength="10">
            </div>
