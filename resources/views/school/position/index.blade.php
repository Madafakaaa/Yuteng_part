...
@section('nav')
    ...
    <li class="breadcrumb-item active">岗位设置</li>
@endsection
          ...
          <form action="" method="get" id="filter" name="filter">
            <div class="row m-2">
              <div class="col-lg-2 col-md-3 col-sm-4 mb-1">
                <input class="form-control" type="text" name="filter1" placeholder="岗位名称..." autocomplete="off">
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 mb-1">
              ...
              <tr>
                ...
                <td class="p-2">
                  <form action="position/{{$row->position_id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href='/position/{{$row->position_id}}/edit'><button type="button" class="btn btn-primary btn-sm">修改信息</button></a>
