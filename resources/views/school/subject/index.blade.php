    ...
    <div class="col-12 card-wrapper ct-example">
      ...
      <div class="card main_card" style="display:none">
        ...
        <div class="card-header border-0">
          <div class="row">
            <div class="col-6">
              <h2 class="mb-0">科目列表</h2>
            </div>
            <div class="col-6 text-right">
              <a href="/subject/create" class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="tooltip" data-original-title="添加科目">
                <span class="btn-inner--icon"><i class="fas fa-user-edit"></i></span>
                <span class="btn-inner--text">添加科目</span>
              </a>
            </div>
          </div>
        </div>
          ...
          <table class="table align-items-center table-flush table-hover text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="p-2">
                  <form action="subject/{{$row->subject_id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href='/subject/{{$row->subject_id}}/edit'><button type="button" class="btn btn-primary btn-sm">修改信息</button></a>
                    {{ deleteConfirm($row->subject_id, ["科目名称：".$row->subject_name]) }}
                  </form>
                </td>
              </tr>
              @endforeach
