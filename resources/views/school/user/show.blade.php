        ...
        <div class="card-body">
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="{{ $user->user_gender }}" readonly>
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="等级{{ $user->user_level }}" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="{{ $user->user_dateOfEntry }}" readonly>
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
                    <label class="form-control-label">用户手机</label>
                    <input class="form-control" type="text" value="{{ $user->user_phone }}" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="{{ $user->user_wechat }}" readonly>
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-4">
                  <a href="/user/{{ $user->user_id }}/edit"><button class="btn btn-block btn-warning">修改</button></a>
                </div>
              </div>
            </div>
