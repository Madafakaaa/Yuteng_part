...
@section('nav')
<h2 class="text-white d-inline-block mb-0">我的未签约学生</h2>
<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
    <li class="breadcrumb-item"><a href="/home"><i class="fas fa-home"></i></a></li>
    <li class="breadcrumb-item active">个人中心</li>
    <li class="breadcrumb-item active">我的未签约学生</li>
  </ol>
</nav>
@endsection
...
<div class="container-fluid mt-4">
  <div class="row mb-3">
    <div class="col-auto">
      <a href="/self/customer/create" class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="tooltip" data-original-title="添加客户">
        <span class="btn-inner--icon"><i class="fas fa-user-edit"></i></span>
        <span class="btn-inner--text">添加客户</span>
      </a>
      <button class="btn btn-sm btn-outline-danger btn-round btn-icon" data-toggle="tooltip" data-original-title="批量删除" onclick="batchDeleteConfirm('/self/customer/delete', '确认批量删除所选客户？')">
          ...
          <table class="table align-items-center table-hover table-bordered text-left">
            ...
            <tbody>
              ...
              <tr>
                ...
                @endif
                <td>
                  <a href="/self/customer/contract/create?id={{encode($row->student_id, 'student_id')}}"><button type="button" class="btn btn-warning btn-sm">签约合同</button></a>
                  <button type="button" class="btn btn-outline-danger btn-sm delete-button" id='delete_button_{{$loop->iteration}}' onclick="deleteConfirm('delete_button_{{$loop->iteration}}', '/self/customer/delete?id={{encode($row->student_id, 'student_id')}}', '确认删除客户？')">删除</button>
                </td>
              </tr>
              @endforeach
            </tbody>
