...
<div class="container-fluid mt-4">
  <form action="/self/adviser/student/contract/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submit_button')">
    @csrf
    <div class="row">
      <div class="col-4">
        <div class="card">
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="?id={{ encode($student->student_id, 'student_id') }}"><button type="button" class="btn btn-sm btn-outline-primary">
                  重新选择
                </button></a>
