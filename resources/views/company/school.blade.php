    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-6 text-right">
          <a href="/company/school/create" class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="tooltip" data-original-title="添加学校">
          ...
          <table class="table align-items-center table-hover text-left table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form action="/company/school/{{$row->school_id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href='/company/school/{{$row->school_id}}'><button type="button" class="btn btn-primary btn-sm">修改</button></a>
