...
@section('nav')
<h2 class="text-white d-inline-block mb-0">大区管理</h2>
...
<div class="container-fluid mt-3">
  <div class="row mb-3">
    <div class="col-auto">
      <a href="/company/school/create" class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="tooltip" data-original-title="添加大区">
      ...
      <button class="btn btn-sm btn-outline-danger btn-round btn-icon" data-toggle="tooltip" data-original-title="批量删除" onclick="batchDeleteConfirm('/company/school/delete', '确认批量删除所选大区？')">
              ...
              <tr>
                <td>
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="checkbox_{{ $loop->iteration }}" name="id" value='{{encode($row->school_id, 'school_id')}}'>
                ...
                <td>
                  <a href='/company/school/edit?id={{encode($row->school_id, 'school_id')}}'><button type="button" class="btn btn-primary btn-sm">修改</button></a>
                  <button type="button" class="btn btn-outline-danger btn-sm delete-button" id='delete_button_{{$loop->iteration}}' onclick="deleteConfirm('delete_button_{{$loop->iteration}}', '/company/school/delete?id={{encode($row->school_id, 'school_id')}}', '确认删除大区？')">删除</button>
                </td>
