...
@section('nav')
<h2 class="text-white d-inline-block mb-0">添加部门</h2>
...
<div class="container-fluid mt-4">
  <div class="row justify-content-center">
    <div class="col-lg-6 col-md-7 col-sm-12 card-wrapper">
      <div class="card">
        <form action="/company/section/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
          @csrf
          <div class="card-header">
            <h3 class="mb-0">添加部门</h3>
          </div>
          <!-- Card body -->
          <div class="card-body">
            <div class="row">
