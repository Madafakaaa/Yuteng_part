...
@section('nav')
<h2 class="text-white d-inline-block mb-0">添加教室</h2>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-6 col-md-9 col-sm-12 card-wrapper ct-example">
      <div class="card main_card" style="display:none">
        <form action="/company/classroom/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
          @csrf
          <div class="card-header">
            <h3 class="mb-0">添加教室</h3>
          </div>
          <!-- Card body -->
          <div class="card-body">
            <div class="row">
