          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_name }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">联系电话</label>
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_phone }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->department_name }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">来源类型</label>
                <input class="form-control form-control-sm" type="text" value="{{ $customer->source_name }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_wechat }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">客户关系</label>
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_relationship }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->course_name }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">负责人</label>
                <input class="form-control form-control-sm" type="text" value="{{ $customer->user_name }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_student_name }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">学生年级</label>
                <input class="form-control form-control-sm" type="text" value="{{ $customer->grade_name }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_remark }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" value="{{ $customer->customer_createtime }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-4">
              <a href="/customer/{{ $customer->customer_id }}/edit"><button class="btn btn-block btn-primary">修改</button></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card main_card" style="display:none">
        ...
        <div class="card-body">
          <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
            @foreach ($follow_records as $follow_record)
              <div class="timeline-block">
                @if($follow_record->follow_record_conversed==0)
                ...
                <div class="timeline-content">
                  <small class="text-muted font-weight-bold">{{ $follow_record->follow_record_createtime }}</small>
                  <h5 class=" mt-3 mb-0">
                    跟进人：{{ $follow_record->user_name }}
                  </h5>
                  <p class=" text-sm mt-1 mb-0">
                    {{ $follow_record->follow_record_remark }}
                  </p>
                </div>
              </div>
            @endforeach
