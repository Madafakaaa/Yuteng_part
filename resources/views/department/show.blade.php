      ...
      <div class="card main_card" style="display:none">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">电话1</label>
                <input class="form-control" type="text" value="{{ $department->department_phone1 }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">电话1</label>
                <input class="form-control" type="text" value="{{ $department->department_phone2 }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" value="{{ $department->department_location }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-4">
              <a href="/department/{{ $department->department_id }}/edit"><button class="btn btn-block btn-primary">修改</button></a>
            </div>
          </div>
        </div>
      </div>
