...
<div class="container-fluid mt-3">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
      <div class="card card-stats mb-2">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col">
              <h4 class="card-title text-uppercase mb-1 text-muted">首签单数</h4>
              <span class="h2 font-weight-bold mb-1 text-blue">{{$dashboard['sum_new_contract_num']}}</span>
            </div>
            <div class="col-auto">
              <div class="icon icon-shape bg-blue text-white rounded-circle shadow">
          ...
          <p class="mt-2 mb-0 text-sm">
            @if($dashboard['sum_contract_num_change']>0)
            <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> {{ $dashboard['sum_new_contract_num_change'] }}%</span>
            <span class="text-nowrap text-muted">较上月</span>
            @elseif($dashboard['sum_contract_num_change']==0)
            <span class="text-info mr-2"><i class="fa fa-minus"></i> 0%</span>
            <span class="text-nowrap text-muted">较上月</span>
            @else
            <span class="text-danger mr-2"><i class="fa fa-arrow-down"></i> {{ $dashboard['sum_new_contract_num_change'] }}%</span>
            <span class="text-nowrap text-muted">较上月</span>
            @endif
          </p>
        </div>
    ...
    <div class="col-12">
      <div class="card my-1">
        <div class="card-header">
          <h3 class="mb-0">部门统计 <a href="/finance/contract/department" class="text-blue"><small>查看明细</small></a></h3>
        </div>
  ...
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="card my-2">
        <div class="card-header">
          <h3 class="mb-0">个人统计 <a href="/finance/contract/user" class="text-blue"><small>查看明细</small></a></h3>
        </div>
        <div class="table-responsive py-4">
          <table class="table table-flush datatable-basic">
            <thead class="thead-light">
