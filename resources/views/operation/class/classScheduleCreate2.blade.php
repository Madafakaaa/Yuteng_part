...
@section('nav')
<h2 class="text-white d-inline-block mb-0">班级排课</h2>
                ...
                <div class="form-group mb-1">
                  <div class="row">
                    <div class="col-6 pl-2 pr-2 mb-2">
                      <label>{{ $schedule_class->class_name }}</label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-9">
                <div class="form-group mb-1">
                  <div class="row">
                    <div class="col-6 pl-2 pr-2 mb-2">
                      <label>{{ $schedule_class->department_name }}</label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-9">
                <div class="form-group mb-1">
                  <div class="row">
                    <div class="col-6 pl-2 pr-2 mb-2">
                      <label>{{ $schedule_class->grade_name }}</label>
                    </div>
                  </div>
                </div>
              </div>
