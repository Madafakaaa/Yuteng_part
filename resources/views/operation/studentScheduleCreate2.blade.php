  ...
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12 card-wrapper ct-example">
      <div class="card main_card" style="display:none">
        <form action="/operation/studentSchedule/create3" method="post" id="form1" name="form1">
          @csrf
          ...
          <div class="card-body pt-2">
            ...
            <div class="row">
              <div class="col-2 text-right">
                <label class="form-control-label"><span style="color:red">*</span>可选学生</label>
              </div>
              <div class="col-10">
                <div class="form-group mb-1">
                  <div class="row">
                    <div class="col-6 pl-2 pr-2 mb-2">
                      <select class="form-control form-control-sm" name="input1" data-toggle="select" required>
                        ...
                        @foreach ($students as $student)
                          @if($student[2]==0)
                            <option value="{{ $student[0] }}">{{ $student[3] }} - {{ $student[1] }}</option>
                          @endif
                        @endforeach
                      </select>
                    </div>
