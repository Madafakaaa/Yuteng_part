...
@section('nav')
<h2 class="text-white d-inline-block mb-0">课程表 @if (Session::get('user_access_self')==1) （个人点名） @endif</h2>
...
$(document).ready(function(){
    calendar_weekly(
      ...
      "/operation/calendar/day?@foreach($filters as $key => $value) @if($key!='filter_date') {{$key}}={{$value}}& @endif @endforeach"
    );
});
