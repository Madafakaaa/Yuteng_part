          ...
          <div class="card-body pt-2">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/operation/classSchedule/create?class_id={{ $class_id }}" ><button type="button" class="btn btn-outline-primary btn-block">再次排课</button></a>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/class/{{ $class_id }}" ><button type="button" class="btn btn-outline-primary btn-block">查看班级详情</button></a>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/operation/class/all" ><button type="button" class="btn btn-outline-primary btn-block">班级管理</button></a>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-12">
