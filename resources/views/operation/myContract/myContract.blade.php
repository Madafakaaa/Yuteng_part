  ...
  <div class="container-fluid">
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-6">
          <h6 class="h2 text-white d-inline-block mb-0">我的签约</h6>
              ...
              <tr>
                ...
                <td>
                  @if($row->contract_total_price!=$row->contract_paid_price)
                    <a href='/operation/myContract/edit?id={{encode($row->contract_id, 'contract_id')}}'><button type="button" class="btn btn-info btn-sm">补缴</button></a>
                  @endif
                  ...
                  <button type="button" class="btn btn-outline-danger btn-sm delete-button" id='delete_button_{{$loop->iteration}}' onclick="deleteConfirm('delete_button_{{$loop->iteration}}', '/operation/myContract/delete?id={{encode($row->contract_id, 'contract_id')}}', '确认删除合同？')">删除</button>
                </td>
...
<script>
  ...
  linkActive('operationContractMy');
</script>
@endsection
