...
<div class="container-fluid mt-3">
  <div class="row mb-3">
    <div class="col-auto">
      ...
      <!--
      <button class="btn btn-sm btn-outline-danger btn-round btn-icon" data-toggle="tooltip" data-original-title="批量删除" onclick="batchDeleteConfirm('/operation/student/deleted/delete', '确认批量彻底删除所选学生？')">
