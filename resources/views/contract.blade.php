  ...
  <div class="col-12">
      ...
      <div class="card-body m-1 p-2">
        ...
        <div class="row m-1 px-2 pt-2">
          ...
          <div class="col-12 mb-4">
            <table class="table" style="border:1px solid #32325d; table-layout:fixed;">
    ...
    <div class="card m-4">
      ...
      <div class="card-body m-1 p-2">
          ...
          <div class="col-12">
            <h3 class="mb-1 mx-4">
              <span style="font-family: 华文中宋; font-weight:normal;">
                ...
                <u>
                  <strong>
                    退费处理，甲方将扣除乙方一次性建档费、税费、拉卡手续费和已消耗原价课时费用（其计算方法为：原价收费标准 * 已完成辅导的课时数量），退费时，已完成课时数不再享受任何折扣优惠，赠送课时不退费，剩余费用将在40-45个工作日全部退还给乙方。
                  </strong>
                </u>
              </span>
            </h3>
        ...
        <div class="row mx-1 mt-3 mb-0 px-2">
