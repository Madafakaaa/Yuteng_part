  ...
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12 card-wrapper ct-example">
      <div class="card main_card" style="display:none">
        <form action="/schedule/create/step2Irregular" method="post" id="form1" name="form1">
          @csrf
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-3">
                <a href="/schedule/create" ><button type="button" class="btn btn-outline-default btn-block">规律排课</button></a>
              </div>
              <div class="col-6"></div>
              <div class="col-3">
