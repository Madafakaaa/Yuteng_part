...
<div class="container-fluid mt-4">
  <form action="/market/myCustomer/contract/store" method="post" id="form1" name="form1">
    @csrf
    <div class="row">
      <div class="col-4">
        <div class="card">
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="/market/myCustomer/contract/create?id={{ encode($student->student_id, 'student_id') }}"><button type="button" class="btn btn-sm btn-outline-primary">
                  重新选择
                </button></a>
...
function addCourse(course_id, course_name, course_type, course_unit_price, course_type_icon_path){
    ...
    tr += "<td><input class='form-control form-control-sm' type='number' value='100' autocomplete='off' required max='100' min='0' step='1' name='course_"+selected_course_num+"_4' id='course_"+selected_course_num+"_4' oninput='update()'></td>";
