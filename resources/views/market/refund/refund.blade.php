            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <button type="button" class="btn btn-outline-danger btn-sm delete-button" id='delete_button_{{$loop->iteration}}' onclick="deleteConfirm('delete_button_{{$loop->iteration}}', '/market/refund/delete?id={{encode($row->refund_id, 'refund_id')}}', '确认删除退费记录？')">删除</button>
                </td>
