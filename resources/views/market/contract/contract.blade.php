              ...
              <tr>
                ...
                <td>
                  @if($row->contract_total_price!=$row->contract_paid_price)
                    <a href='/market/contract/edit?id={{encode($row->contract_id, 'contract_id')}}'><button type="button" class="btn btn-info btn-sm">补缴</button></a>
                  @endif
                  ...
                  <button type="button" class="btn btn-outline-danger btn-sm delete-button" id='delete_button_{{$loop->iteration}}' onclick="deleteConfirm('delete_button_{{$loop->iteration}}', '/market/contract/delete?id={{encode($row->contract_id, 'contract_id')}}', '确认删除合同？')">删除</button>
                </td>
