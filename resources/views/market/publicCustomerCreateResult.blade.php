          ...
          <div class="card-body pt-2">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/market/publicCustomer/create" ><button type="button" class="btn btn-outline-primary btn-block">继续添加客户</button></a>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/student/{{ $student_id }}" ><button type="button" class="btn btn-outline-primary btn-block">查看客户详情</button></a>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/operation/customer/all" ><button type="button" class="btn btn-outline-primary btn-block">客户管理</button></a>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/market/customer/consultant/edit?student_id={{$student_id}}" ><button type="button" class="btn btn-outline-primary btn-block">修改课程顾问</button></a>
              </div>
            </div>
          </div>
        <form>
