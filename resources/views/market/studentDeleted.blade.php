          ...
          <table class="table align-items-center table-hover text-left table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                @endif
                <td>
                  <form action="/market/student/deleted/{{$row->student_id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href='/student/{{$row->student_id}}'><button type="button" class="btn btn-primary btn-sm">学生详情</button></a>
                    <a href='/market/student/deleted/restore/{{$row->student_id}}'><button type="button" class="btn btn-outline-primary btn-sm">恢复</button></a>
...
<script>
  ...
  linkActive('marketStudentDeleted');
</script>
@endsection
