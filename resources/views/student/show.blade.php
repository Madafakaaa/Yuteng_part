      ...
      <div class="card main_card" style="display:none">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">监护人</label>
                <input class="form-control" type="text" value="{{ $student->student_guardian }}" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label class="form-control-label">关系</label>
                <input class="form-control" type="text" value="{{ $student->student_guardian_relationship }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-4">
              <a href="/student/{{ $student->student_id }}/edit"><button class="btn btn-block btn-primary">修改</button></a>
            </div>
          </div>
        </div>
      </div>
