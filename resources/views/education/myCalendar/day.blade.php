          ...
          <form action="" method="get" onsubmit="submitButtonDisable('submitButton1')">
            <div class="row">
              <div class="col-6">
                ...
                <a href="/education/myCalendar/week?@foreach($filters as $key => $value){{$key}}={{$value}}&@endforeach"><button type="button" class="btn btn-outline-primary btn-sm">返回周课程表</button></a>
              </div>
              <div class="col-3">
              </div>
