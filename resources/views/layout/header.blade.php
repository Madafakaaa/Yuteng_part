...
<head>
  ...
  <!-- Page plugins -->
  <link rel="stylesheet" href="{{ asset(_ASSETS_.'/vendor/animate.css/animate.min.css') }}">
  <link rel="stylesheet" href="{{ asset(_ASSETS_.'/vendor/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
