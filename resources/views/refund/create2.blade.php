  ...
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12 card-wrapper ct-example">
      <div class="card main_card" style="display:none">
        <form action="/refund/create/step3" method="post" id="form1" name="form1">
          @csrf
                ...
                <div class="form-group mb-1">
                  <select class="form-control form-control-sm" name="input2" data-toggle="select" required>
                    ...
                    @foreach ($hours as $hour)
                      <option value="{{ $hour->hour_id }}">课程: {{ $hour->course_name }}, 剩余课时: {{ $hour->hour_remain }}. (合同号: {{ $hour->hour_contract }})</option>
                    @endforeach
                  </select>
                </div>
              </div>
