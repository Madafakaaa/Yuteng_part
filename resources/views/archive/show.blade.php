...
@section('nav')
    ...
    <li class="breadcrumb-item active">档案详情</li>
@endsection
    ...
    <div class="col-lg-4 col-md-8 col-sm-12 card-wrapper ct-example">
      <div class="card main_card" style="display:none">
        <div class="card-header">
          <h3 class="mb-0">档案详情</h3>
        </div>
        <!-- Card body -->
        <div class="card-body">
          <div class="form-group">
            <label class="form-control-label">档案序号</label>
            <input class="form-control" type="text" value="{{ $archive->archive_id }}" readonly>
          </div>
          <div class="form-group">
            <label class="form-control-label">档案名称</label>
            <input class="form-control" type="text" value="{{ $archive->archive_name }}" readonly>
          </div>
          <div class="form-group">
            <label class="form-control-label">添加时间</label>
            <input class="form-control" type="text" value="{{ $archive->archive_createtime }}" readonly>
          </div>
          <a href="/archive/{{ $archive->archive_id }}/edit"><button class="btn btn-warning">修改</button></a>
        </div>
      </div>
    </div>
  </div>
