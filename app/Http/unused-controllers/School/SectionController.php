...
class SectionController extends Controller
{
    ...
    public function index(Request $request){
        ...
        // 返回列表视图
        return view('school/section/index', ['rows' => $rows,
                                             'sections' => $sections,
    ...
    public function create(){
        ...
        return view('school/section/create');
    }
    ...
    public function store(Request $request){
        ...
        // 捕获异常
            ...
            return redirect()->action('School\SectionController@index')
                             ->with(['notify' => true,
                                     'type' => 'danger',
                                     'title' => '部门添加失败',
    ...
    public function edit($section_id){
        ...
        $section = $section[0];
        return view('school/section/edit', ['section' => $section]);
    }
