...
class ConsultantStudentController extends Controller
{
    ...
    public function student(Request $request){
        ...
        $filter_students = DB::table('student')
                             ...
                             ->get();
        // 返回列表视图
        return view('self/consultantStudent/student', ['students' => $students,
    ...
    public function studentContractCreate(Request $request){
        ...
        $payment_methods = DB::table('payment_method')
                             ...
                             ->get();
        return view('self/consultantStudent/studentContractCreate', ['student' => $student,
                                                                     'hours' => $hours,
    ...
    public function studentContractStore(Request $request){
        ...
        // 捕获异常
            ...
            DB::rollBack();
            // 返回购课界面
            return redirect("/self/consultant/student/contract/create?id=".encode($request_student_id, 'student_id'))
                   ->with(['notify' => true,
                         'type' => 'danger',
                         'title' => '购课添加失败',
        ...
        $student_name = DB::table('student')
                          ...
                          ->value('student_name');
        // 返回购课列表
        return redirect("/self/consultant/student/contract/success?student_id=".encode($contract_student, 'student_id')."&contract_id=".encode($contract_id, 'contract_id'))
               ->with(['notify' => true,
                       'type' => 'success',
                       'title' => '合同添加成功',
                       'message' => '合同添加成功']);
    ...
    public function studentContractSuccess(Request $request){
        return view('self/consultantStudent/studentContractCreateSuccess', ['student_id' => $request->input('student_id'), 'contract_id' => $request->input('contract_id')]);
    }
}
