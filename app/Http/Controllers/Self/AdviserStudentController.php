...
class AdviserStudentController extends Controller
{
    ...
    public function student(Request $request){
        ...
        $filter_students = DB::table('student')
                             ...
                             ->get();
        // 返回列表视图
        return view('self/adviserStudent/student', ['students' => $students,
    ...
    /**
     * 安排学生课程视图
     * URL: GET /self/adviser/studentSchedule/create
     */
    public function studentScheduleCreate(Request $request){
        ...
        // 获取年级、科目、用户信息
        return view('self/adviserStudent/studentScheduleCreate', ['student' => $student,
                                                                'teachers' => $teachers,
    ...
    /**
     * 安排学生课程视图2
     * URL: GET /self/adviser/studentSchedule/create2
     * @param  Request  $request
    ...
    public function studentScheduleCreate2(Request $request){
        ...
        if(!isset($schedule_days)){
            return redirect("/self/adviser/student/schedule/create?id=".encode($schedule_student, 'student_id'))
                   ->with(['notify' => true,
                           'type' => 'danger',
                           'title' => '未选择上课规律',
        ...
        return view('self/adviserStudent/studentScheduleCreate2', ['teacher_schedules' => $teacher_schedules,
    ...
    /**
     * 安排学生课程提交
     * URL: POST /self/adviser/studentSchedule/store
     * @param  Request  $request
    ...
    public function studentScheduleStore(Request $request){
        ...
        DB::commit();
        // 返回本校课程安排列表
        return redirect("/self/adviser/student/schedule/success?id=".encode($schedule_student, 'student_id'))
               ->with(['notify' => true,
                       'type' => 'success',
                       'title' => '课程安排成功',
                       'message' => '课程安排成功']);
    ...
    public function studentScheduleCreateSuccess(Request $request){
        return view('self/adviserStudent/studentScheduleCreateSuccess', ['id' => $request->input('id')]);
    }
    ...
    public function studentContractCreate(Request $request){
        ...
        $payment_methods = DB::table('payment_method')
                             ...
                             ->get();
        return view('self/adviserStudent/studentContractCreate', ['student' => $student,
                                                                 'hours' => $hours,
    ...
    public function studentContractStore(Request $request){
        ...
        // 捕获异常
            ...
            DB::rollBack();
            // 返回购课界面
            return redirect("/self/adviser/student/contract/create?id=".encode($request_student_id, 'student_id'))
                   ->with(['notify' => true,
                         'type' => 'danger',
                         'title' => '购课添加失败',
        ...
        $student_name = DB::table('student')
                          ...
                          ->value('student_name');
        // 返回购课列表
        return redirect("/self/adviser/student/contract/success?student_id=".encode($contract_student, 'student_id')."&contract_id=".encode($contract_id, 'contract_id'))
               ->with(['notify' => true,
                       'type' => 'success',
                       'title' => '合同添加成功',
                       'message' => '合同添加成功']);
    ...
    public function studentContractSuccess(Request $request){
        return view('self/adviserStudent/studentContractCreateSuccess', ['student_id' => $request->input('student_id'), 'contract_id' => $request->input('contract_id')]);
    }
}
