...
class StudentController extends Controller
{
    ...
    public function create(){
        ...
        return view('teaching/student/create', ['departments' => $departments,
                                                'grades' => $grades,
                                                'schools' => $schools]);
    }
    ...
    public function store(Request $request){
        ...
        // 返回学生列表
        return redirect()->action('Teaching\StudentController@index')
                         ->with(['notify' => true,
                                 'type' => 'success',
                                 'title' => '学生添加成功',
    ...
    public function show($student_id){
        ...
        $student = $student[0];
        return view('teaching/student/show', ['student' => $student]);
    }
    ...
    public function edit($student_id){
        ...
        $grades = DB::table('grade')->where('grade_status', 1)->orderBy('grade_createtime', 'asc')->get();
        $schools = DB::table('school')->where('school_status', 1)->orderBy('school_createtime', 'asc')->get();
        return view('teaching/student/edit', ['student' => $student,
